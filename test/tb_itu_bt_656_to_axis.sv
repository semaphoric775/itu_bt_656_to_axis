...
// Instantiates interfaces internally and exposes flat ports for cocotb.
// Clock is generated here so cocotb does not need to drive it.

module tb_itu_bt_656_to_axis;
